      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <div className="flex-1">
            ...
            >
              {isAr
                ? "تأسست فيزيوتريو عام 2013 لتكون الوجهة الأولى للعلاج الطبيعي وإعادة التأهيل في المملكة، في فرعَي الرياض ومكة المكرمة."
                : "PhysioTrio was established in 2013 to be a leading physiotherapy destination in Saudi Arabia, serving patients across Riyadh and Makkah."}
            </p>
          </div>
